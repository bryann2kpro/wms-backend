...
ALTER TABLE "main"."m_transports" ADD CONSTRAINT "m_transports_storage_bin_id_m_racks_rack_id_fk" FOREIGN KEY ("storage_bin_id") REFERENCES "main"."m_racks"("rack_id") ON DELETE no action ON UPDATE no action;